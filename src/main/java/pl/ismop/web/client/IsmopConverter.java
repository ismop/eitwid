...
public class IsmopConverter {
	...
	public List<String> shortDays() {
		List<String> result = new ArrayList<>();
    	DateTimeFormat shortMonths = DateTimeFormat.getFormat("EEE");
	...
	public List<String> minDays() {
		List<String> result = new ArrayList<>();
    	DateTimeFormat shortMonths = DateTimeFormat.getFormat("E");
