package pl.ismop.web.client.widgets.old.experiment;
...
import pl.ismop.web.client.widgets.old.experiment.IExperimentView.IExperimentPresenter;
...
public class ExperimentView extends Composite implements IExperimentView, ReverseViewInterface<IExperimentPresenter> {
	...
	private native void regenerateWave(String data) /*-{
		...
		if(this.@pl.ismop.web.client.widgets.old.experiment.ExperimentView::pompsActive) {
